...
class MySQLWrapper
{
    ...
    public function connect(): void
    {
        ...
        try {
            ...
            throw new RuntimeException(__('Database connection failed.'), 500, $throwable);
        }
    }
    ...
    public function query(string $sql, array $params = []): PDOStatement
    {
        ...
        try {
            ...
            LogViaStream::send(LogLevel::ERROR, 'Query execution failure event', $context);

            throw new RuntimeException(__('Internal query execution error.'), 500, $throwable);
        }
    }
    ...
    private function logEmergency(string $message, array $context): void
    {
        try {
            ...
            error_log("Emergency logging failed: " . $throwable->getMessage());
        }
    }
}