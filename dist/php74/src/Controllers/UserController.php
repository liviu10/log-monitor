...
class UserController extends BaseController
{
    ...
    public function index(): void
    {
        ...
        try {
            ...
            LogViaStream::send(LogLevel::ERROR, 'Failed to fetch database users list', [
                'location' => __METHOD__,
                'line' => __LINE__,
            ...
            throw new \RuntimeException(__('Unable to retrieve administrators list.'), $throwable->getCode(), $throwable);
        }
    }
    ...
    public function store(array $data): void
    {
        ...
        try {
            ...
            LogViaStream::send(LogLevel::ERROR, 'Admin user creation process exception', [
                'location' => __METHOD__,
                'line' => __LINE__,
                'exception_message' => $throwable->getMessage(),
                'exception_file' => $throwable->getFile(),
