...
class AppSetting
{
    ...
    public function updateSetting(int $appId, string $oldKey, array $data): void
    {
        ...
        if ($trimmedOldKey !== $newKey && $this->getSetting($appId, $newKey) !== null) {
        ...
        try {
            ...
            throw new RuntimeException(__('Database error during settings update modification'), 0, $pdoException);
        }
    }
    ...
    public function deleteSetting(int $appId, string $key): void
    {
        ...
        try {
            ...
            throw new RuntimeException(__('Database error during setting removal'), 0, $pdoException);
        }
    }
}